...
class ATimer extends HTMLElement {
  ...
  */
  ...
  _start() {
    ...
    this._startCssAnimations();    
    // if (this._animatable) this._animatable.style["-webkit-animation-play-state"] = 'running';    
  ...
  _stop() {
    ...
    // if (this._animatable) this._animatable.style["-webkit-animation-play-state"] = 'paused';    
  ...
  */
  ...
  _restartElementCssAnimation(animatedEl) {
    ...
    setTimeout(() => {
        ...
        this._pauseElementCssAnimation(me);
    }, 10);
  ...
  _animationEnd(e) {
    ...
    this._animatable.animationPlayState = "paused";
    this._pauseCssAnimations();
    // this._animatable.style["-webkit-animation-play-state"] = 'paused';
  }
  ...
  */
  _connectSlots() {
    ...
    // animatable.style["-webkit-animation-name"] = 'rota';
    // animatable.style["-webkit-animation-iteration-count"] = `1`;
    // animatable.style["-webkit-animation-duration"] = `${this.startTime}s`;    
    // animatable.style["-webkit-animation-play-state"] = 'paused'
    
    
    var all = Array.from(this._animatable.getElementsByTagName("*"));
    // console.log(all)
    // console.log(typeof all)
    // let animationNames = all.map((el) => getStyle(el, "animationName", "-webkit-animation-name"));
    // let animationNamesSet = [ ...new Set(animationNames) ]
    // console.log(animationNames)
    // console.log(animationNamesSet)
    // console.log(animationNamesSet)
    ...
    for (var i=0, max=all.length; i < max; i++) {
      ...
      if (animationDuration) animatedElements.push(el);
      // animationNamesSet.add(animationName);
      // console.log(el)
      // console.log(getStyle(el, "animationName", "-webkit-animation-name"))
    }
